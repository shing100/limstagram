...
ROOT_DIR = environ.Path(__file__) - 3  # (limstagram/config/settings/base.py - 3 = limstagram/)
APPS_DIR = ROOT_DIR.path('limstagram')
...
MIGRATION_MODULES = {
    'sites': 'limstagram.contrib.sites.migrations'
}
...
REST_AUTH_REGISTER_SERIALIZERS = {
    'REGISTER_SERIALIZER': 'limstagram.users.serializers.SignUpSerializer'
}

REST_AUTH_SERIALIZERS = {
    'USER_DETAILS_SERIALIZER': 'limstagram.users.serializers.UserProfileSerializer'
}
